...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#121A1D] text-[#797B78] flex flex-col items-center px-6 sm:px-10 md:px-16 lg:px-20 2xl:px-44 py-12">
      ...
      {/* Map Section moved below the grid */}
      <div className="w-full mt-8">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.1010310662523!2d85.30976627602165!3d27.714166725189717!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb18fd6bd5f3d9%3A0x8339f47f4db7fb58!2sLoulan%20Chinese%20Korean%20Restaurant%20%26%20Bar!5e0!3m2!1sen!2snp!4v1748705875788!5m2!1sen!2snp"
          width="100%"
          height="400"
          style={{ border: 0 }}
          allowFullScreen
          ...
          title="Loulan Restaurant Location"
        />
      </div>
    </footer>
  );
